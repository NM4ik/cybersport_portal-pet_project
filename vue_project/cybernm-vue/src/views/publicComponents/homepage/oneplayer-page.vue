    ...
    <div class="main_info">
      ...
      <div class="card">
        <v-card class="ml-15 v-cards" elevation="2">
          <v-card-title
            >player:<span>{{ User.nickname }}</span></v-card-title
          >
          <v-card-text>
            <ul class="tournament_description">
              <li>
                first_name: <span>{{ User.first_name }}</span>
              </li>
              <li>
                second_name <span>{{ User.last_name }}</span>
              </li>
              <li>
                birth_date: <span>{{ User.birth_date }}</span>
              </li>
              <li>
