  ...
  <v-card flat tile>
    <v-container class="grey lighten-4" fluid>
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            <v-card-title class="text-h5"
              >Are you sure you want to delete this player?</v-card-title
            >
            <v-card-actions>
              <v-spacer></v-spacer>
      ...
      <v-row dense>
        ...
        >
          <v-card>
            <v-img :src="card.user_image" alt="user_image" height="300px">
              <span
            ...
            <v-card-actions class="white justify-end">
              <v-icon class="mr-3" @click="editItem(card)"> mdi-pencil </v-icon>
...
export default {
  ...
  methods: {
    ...
    async addPLayer() {
      await fetch(`${this.$store.getters.getServerUrl}Addplayer/`, {
        method: "post",
        headers: {
          "Content-Type": "application/json",
        },
