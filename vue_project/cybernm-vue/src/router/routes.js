export default [
...

  {
    ...
    meta: { layout: "public_layout" },
    component: () =>
      import("@/views/publicComponents/homepage/playerspage.vue"),
  },

  {
    ...
    meta: { layout: "public_layout" },
    component: () =>
      import("@/views/publicComponents/homepage/tournamentspage.vue"),
  },

  {
    ...
    meta: { layout: "public_layout" },
    component: () =>
      import("@/views/publicComponents/homepage/discipline-page.vue"),
  },

  {
    ...
    meta: { layout: "public_layout" },
    component: () =>
      import("@/views/publicComponents/homepage/onetournamentpage.vue"),
  },
...

  {
    ...
    meta: { layout: "public_layout" },
    component: () =>
      import("@/views/publicComponents/homepage/oneplayer-page.vue"),
  },
